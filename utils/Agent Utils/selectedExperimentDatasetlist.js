/**
 * ⭐ SELECTED EXPERIMENT DATASET LIST - Experiment dataset mappings
 * Source: D:\TrueGradient\tg-application\src\utils\Agent Utils\selectedExperimentDatasetlist.js
 */
...
export const getExperimentDatasetPath = (experimentBasePath,DatasetName) => {
  const fileNamePathDict = {
    ...
    "Elasticity Detailed View Promo": `${experimentBasePath}/scenario_planning/K_best/scenario_plan/scenario_planner_data.csv`,
    "Metrics Deep dive": `${experimentBasePath}/scenario_planning/K_best/post_model_demand_pattern/post_model_metrics.csv`,
