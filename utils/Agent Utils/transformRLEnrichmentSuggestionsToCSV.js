/**
 * ⭐ TRANSFORM RL ENRICHMENT TO CSV - Convert enrichment data to CSV
 * Source: D:\TrueGradient\tg-application\src\utils\Agent Utils\transformRLEnrichmentSuggestionsToCSV.js
 */
...
const transformSuggestion = (suggestion) => {
  return {
    ...
    "Approved Enrichment Reward": suggestion["Approved Enrichment"]?.Reward || "",
    "Approved Enrichment Deviation": suggestion["Approved Enrichment"]?.Deviation || "",
    "Comment": suggestion.Comment,
  };
};

export default transformRLEnrichmentSuggestionsToCSV;
