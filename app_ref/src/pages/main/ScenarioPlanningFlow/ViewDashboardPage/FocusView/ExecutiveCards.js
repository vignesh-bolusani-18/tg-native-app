    ...
    case "inventory-optimization":
      return [
        ...
        },
        {
          ...
          extraMetrictitle: "Current Excess Stock",
          extraMetric: formatNumber(transformedData.Excess_Stock),
          extraSubMetric:
        ...
        },
        {
          ...
          extraMetrictitle: "Projected Lost Sales",
          extraMetric: formatNumber(transformedData.Potential_Sales_Loss),
          extraSubMetric:
            formatNumber(transformedData.Potential_Sales_Loss_value) === "0"
              ? "0"
              : `${currency ? currency : ""} ${formatNumber(
    ...
    case "pricing-promotion-optimization":
      return [
...

        {
          ...
          value: "0",
          subMetric1Title: "M-o-M Growth Rate",
          subMetric2Title: "Promotional Lift",
          subMetric1: formatToPercent(transformedData["Current_Growth%"]),
          subMetric2: `--`,
          extraMetrictitle: "Projected Lost Sales",
          extraMetric: formatNumber(transformedData.Potential_Sales_Loss),
