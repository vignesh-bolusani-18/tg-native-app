...
// import MeetingNotesManager from "../../../components/MeetingNoteManager";
        ...
        <Box sx={{ border: "1px solid #EAECF0", borderRadius: "12px" }}>
          ...
          <TabContext value={tableTabValue}>
            ...
            <TabPanel value="liveTable" sx={{ padding: "16px 0" }}>
              <ExpTable currentFlow={"dashboard"} currentTable={"live"} />
            </TabPanel>
            <TabPanel value="archiveTable" sx={{ padding: "16px 0" }}>
              <ExpTable currentFlow={"dashboard"} currentTable={"archive"} />
            </TabPanel>
          </TabContext>
        </Box>
