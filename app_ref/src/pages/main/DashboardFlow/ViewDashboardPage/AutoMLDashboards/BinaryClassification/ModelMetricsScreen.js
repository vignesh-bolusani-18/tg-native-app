...
const BinaryClassificationModelMetricsScreen = () => {
  ...
  const MetricsTables = AllMetricsTables.filter((tableConfig) => models.includes(tableConfig.model));
  return (
    <Box>
      <Tabs
        value={selectedTab}
...
export default BinaryClassificationModelMetricsScreen;
