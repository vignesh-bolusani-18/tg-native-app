...
const ExpRunDetails = () => {
  ...
  const businessData = [
    ...
    {
      label: "Target column:",
      value: `${configState?.data?.target_column}`,
    },
    {
      label: "Driver columns:",
      value: `${configState?.data?.driver_columns}`,
    },
    {
      label: "Forecast from:",
      value: `${configState?.etl?.activity_end_date}`,
    },
    {
      label: "History since days:",
      value: `${configState?.etl?.history}`,
    },
    {
      label: "Forecast horizon:",
      value: `${configState?.data?.forecast_horizon}`,
    },
    {
