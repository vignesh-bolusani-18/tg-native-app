...
const TrialParamsManager = ({ modelType }) => {
  ...
  const { trial_params_mlp, addTrialParams, removeItem, editTrialParams , getTrialParam, configState , featureGroupTypeOptions } =
    useConfig();
  ...
  return (
    <div>
      ...
      >
        ...
        <CustomButton title = {"Add Trial"} variant="contained" color="primary" onClick={handleAdd} disabled = {trial_params?.length >= trial_limit}/>
