...
import { setAdvanceSettingBucketsFilledFlags } from "../../../../../redux/slices/configSlice";
...
const CustomizedButtonStyles = ({
  ...
  const { setCurrentAdvanceSettingBucket, contextBucketsFilledFlags } =
    useConfig();
...
const NewAdvanceSettings = () => {
  ...
  const handleRestore = () => {
    restoreToDefault(currentAdvanceSettingBucket, null);
