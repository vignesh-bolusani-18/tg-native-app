...
export default function AmazonSellerDataConnectionData({
  open,
  handleClose,
  dataConnectionName,
  accessToken,
  ...
  React.useEffect(() => {
    ...
    if (currentDatasetTag !== "none") {
      ...
      const combinedDatasets =  [
        ...
        ...renderDatasets.future_datasets,
        ...renderDatasets.bom_datasets,
        ...renderDatasets.new_product_datasets,
        ...renderDatasets.simple_disaggregation_mapping_datasets,
        ...renderDatasets.rewrite_forecast_datasets,
      ];
