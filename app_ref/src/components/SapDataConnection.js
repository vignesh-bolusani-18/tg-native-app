...
import SapDataConnectionData from "../pages/main/ExperimentFlow/CreateExperimentPage/AddData/SapDataConnectionData";
...
export default function SapDataConnection({
  open,
  handleClose,
  handleOpen,
  dataConnectionID,
  ...
  const [sapDataConnectionDataOpen, setSapDataConnectionDataOpen] =
    useState(false);

  const handleOpenSapDataConnectionData = () => {
    setSapDataConnectionDataOpen(true);
  };
  const handleCloseSapDataConnectionData = () => {
    setSapDataConnectionDataOpen(false);
    handleClose();
  };

  const { loadSapConnectionDataDetails } = useDataConnection();
  ...
  const handleConfirm = async () => {
    ...
    handleOpenSapDataConnectionData();
    await loadSapConnectionDataDetails(
      dataConnectionID,
  ...
  const sapConnectionOptions = ["Inventory", "Products", "Sales"];
  ...
  return (
    <Box>
      ...
      {sapDataConnectionDataOpen && (
        <SapDataConnectionData
          open={sapDataConnectionDataOpen}
          handleClose={handleCloseSapDataConnectionData}
