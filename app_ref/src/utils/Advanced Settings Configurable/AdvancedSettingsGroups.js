...
export const mlAdvancedSettingsGroups = () => {
  ...
  return {
    ...
    FS: {
      title: "Feature Engineering Setting",
      description:
        "Advanced model parameters like model selection and feature selection",
      btnTitle: "Confirm",
      isArray: false,
    ...
    GS: {
      ...
      isArray: false,
      isHyperParam: false,
      features: [mlAdvancedSettingsFields.file_type],
    },
    CD: {
      title: "Calendar Definations",
      description: "Configure Calendar Definations",
      btnTitle: "Confirm",
      isArray: false,
      isHyperParam: false,
      features: [
    ...
    SNOP: {
      title: "S&OP Setting",
      description: "Configure S&OP Setting",
      btnTitle: "Confirm",
      isArray: false,
      isHyperParam: false,
      features: [
