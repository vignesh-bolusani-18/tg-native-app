  ...
  return {
    ...
    SSC: {
      ...
      features: [
        ...
        allContextFieldsList.adjust_lead_time,
        allContextFieldsList.lead_time_reorder_col,
        allContextFieldsList.lead_time_reorder,
        allContextFieldsList.stock_transfer_lead_time_col,
        allContextFieldsList.stock_transfer_lead_time,
        allContextFieldsList.adjusted_lead_time,
        ...
        allContextFieldsList.intransit_date,
        allContextFieldsList.intransit_date_format,
      ],
    },
    STR: {
      ...
      features: [
        ...
        allContextFieldsList.optimize_cutsize,
        allContextFieldsList.size_column,
        allContextFieldsList.all_size_level,
      ],
    },
    BLIT: {
    ...
    PC: {
      title: "Price/Promo Constraints",
      description: "Price/Promo Constraints Description",
      features: hasCurrency
        ? [
            ...
            allContextFieldsList.promo_column,
            allContextFieldsList.base_price,
            allContextFieldsList.postpromo_e_factor,
            allContextFieldsList.postpromo_dip,
            allContextFieldsList.enable_funding,
            allContextFieldsList.funding_column,
            allContextFieldsList.funding_value,
            allContextFieldsList.shipment_selling_price_col,
          ]
        : [
            allContextFieldsList.cost,
            allContextFieldsList.price,
    ...
    OP: {
      ...
      description: "Optimization Parameters Description",
    ...
    PAS: {
      ...
      features: [
        ...
        allContextFieldsList.cutoff_promo,
        allContextFieldsList.promo_lag,
      ],
    },
    PPP: {
