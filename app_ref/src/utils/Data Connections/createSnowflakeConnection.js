...
export const createSnowflakeConnection = async (tokenPayload, currentCompany, userID) => {
  const Token = await getAuthToken(userID);
  console.log("Token:-->", Token);
  console.log("entered in the create connection");
  ...
  if (
    ...
    console.log("You are not authorized to create connection");
  }
};
